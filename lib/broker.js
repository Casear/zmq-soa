  ...
  Broker = (function(_super) {
    ...
    Broker.prototype.onWorkerResponse = function(message, envelope) {
      ...
      if (this.mapping[workerlabel]) {
        ...
        return this.socket.send(new messages.client.ResponseMessage(message.service, message.data, clientEnvelope, mapEnvelope).toFrames());
      } else {
    ...
    Broker.prototype.onWorkerReady = function(message, envelope) {
      ...
      if (!_.indexOf(this.services[service].waiting, e)) {
