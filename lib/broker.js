(function() {
  ...
  Broker = (function(_super) {
    ...
    function Broker(endpoint, options, log) {
      ...
      this.Auth = function(data, cb) {
        if (data.auth) {
          if (cb) {
            if (data.service) {
              return cb(true, data.service, data);
            } else {
              return cb(true, null, data);
            }
          } else {
            return cb(false);
          }
    ...
    Broker.prototype.onWorkerAuth = function(message, envelope) {
      ...
      if (message.data) {
        ...
        try {
          return this.Auth(JSON.parse(message.data.toString()), (function(result, service, data) {
            var e;
            if (result) {
    ...
    Broker.prototype.onClientAuth = function(message, envelope) {
      ...
      if (message.data) {
        logger.debug('Worker auth');
        try {
          return this.Auth(JSON.parse(message.data.toString()), (function(result, data) {
            var e;
            if (result) {
