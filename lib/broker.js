        ...
        if (this.services[service].worker > 0) {
          ...
          if (message instanceof messages.client.RequestMessage) {
            ...
            if (this.brokerService) {
              this.brokerService(worklabel, message, (function(d) {
    ...
    Broker.prototype.onMessage = function(envelope) {
      ...
      if (message) {
        if (message instanceof messages.client.Message) {
          if (message instanceof messages.client.RequestMessage || message instanceof messages.client.BServiceMessage) {
