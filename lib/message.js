(function() {
  var ClientAuthMessage, ClientHandshakeMessage, ClientHeartbeatMessage, ClientMessage, ClientReadyMessage, ClientRequestMessage, ClientRequestNoRMessage, ClientResponseMessage, Message, WorkerAuthMessage, WorkerDisconnectMessage, WorkerHandshakeMessage, WorkerHeartbeatMessage, WorkerMessage, WorkerReadyMessage, WorkerRequestMessage, WorkerResponseMessage, defaultTimeout, fromFrames, fromJSON, logger, protocols, types,
  ...
  ClientRequestNoRMessage = (function(_super) {
    ...
    function ClientRequestNoRMessage(service, data, envelope, time) {
      ...
      ClientRequestNoRMessage.__super__.constructor.call(this, types.client.REQUEST_NR, service, data, envelope, null, time);
    }
