(function() {
  ...
  Message = (function() {
    function Message(protocol, type, service, data, envelope, mapping) {
  ...
  ClientMessage = (function(_super) {
    ...
    function ClientMessage(type, service, data, envelope, mapping) {
      ClientMessage.__super__.constructor.call(this, protocols.client, type, service, data, envelope, mapping);
    }
  ...
  ClientRequestMessage = (function(_super) {
    ...
    function ClientRequestMessage(service, data, envelope, mapping) {
      ClientRequestMessage.__super__.constructor.call(this, types.client.REQUEST, service, data, envelope, mapping);
    }
  ...
  ClientResponseMessage = (function(_super) {
    ...
    function ClientResponseMessage(service, data, envelope, mapping) {
      ClientResponseMessage.__super__.constructor.call(this, types.client.RESPONSE, service, data, envelope, mapping);
    }
  ...
  fromFrames = function(frames, hasEnvelope) {
    var data, envelope, mapping, protocol, service, type;
