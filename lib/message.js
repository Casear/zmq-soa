(function() {
  var ClientMessage, ClientReadyMessage, ClientRequestMessage, ClientRequestNoRMessage, ClientResponseMessage, Message, WorkerDisconnectMessage, WorkerHeartbeatMessage, WorkerMessage, WorkerReadyMessage, WorkerRequestMessage, WorkerResponseMessage, fromFrames, logger, protocols, types,
  ...
  WorkerReadyMessage = (function(_super) {
    ...
    function WorkerReadyMessage(service, envelope) {
      WorkerReadyMessage.__super__.constructor.call(this, types.worker.READY, service, null, envelope);
    }
