(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.onHeartbeat = function() {
    ...
    Client.prototype.onClientMessage = function(msg) {
      ...
      this.done = true;
      if (msg.envelope && this.callback[msg.envelope]) {
        this.callback[msg.envelope](null, JSON.parse(msg.data));
        return delete this.callback[msg.envelope];
      }
    };
