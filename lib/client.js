(function() {
  var Client, crypto, keySize, logger, messages, net, rsa, zmq;
  ...
  Client = (function() {
    ...
    Client.prototype.onMsg = function() {
      var d, data, decipher, decrypted, ex, frames, message, msg, s;
      ...
      if (msg instanceof messages.client.ReadyMessage) {
        ...
        return this.onClientHandshake(msg);
      } else if (msg instanceof messages.client.AuthMessage) {
        logger.debug('client get auth message');
        return this.onClientAuth(msg);
    ...
    Client.prototype.onWorkerHandshake = function(msg) {
      var pub;
      logger.debug('');
      if (msg.data) {
